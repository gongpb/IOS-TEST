...
#import "VideoPlayCollectionViewCell.h"

typedef NS_ENUM(NSInteger,VideoScreenDirection)
{
...
@interface AVPlayerMoreViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>

@property (nonatomic, strong) UICollectionViewFlowLayout *flowLayout;
@property (nonatomic, strong) UICollectionView *collectionView;
//数据记录
@property (nonatomic, assign) CGFloat lastContentOffsetX;
@property (nonatomic, assign)  VideoScreenDirection moveDirection;
@property (nonatomic, strong)  VideoPlayCollectionViewCell *playingCell;
...
@implementation AVPlayerMoreViewController
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    VideoPlayCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:LZBVideoPlayCollectionViewCellID forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView willDisplayCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        self.isFirst = YES;
        VideoPlayCollectionViewCell *firstCell = (VideoPlayCollectionViewCell *)cell;
...
- (void)playFirstCellWithFirst:(VideoPlayCollectionViewCell *)firstCell
{
...
- (void)startPlayerWithUrl:(NSURL *)url coverImageUrl:(NSString *)coverUrl playerSuperView:(UIView *)superView
{
    ...
    __weak __typeof(self) weakSelf = self;
    [[VideoPlayer sharedInstance] playVideoUrl:url coverImageurl:coverUrl showInSuperView:superView];
...
- (void)processNextVideoPlayEventWithDirection:(VideoScreenDirection)direction  index:(NSInteger)index
{
    //获取当前屏幕的cell
    NSArray *visiableCells = [self.collectionView visibleCells];
    NSIndexPath *indexPath = [NSIndexPath indexPathForRow:index inSection:0];
    VideoPlayCollectionViewCell  *nextCell = (VideoPlayCollectionViewCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
...
-(UICollectionView *)collectionView
{
    if(_collectionView == nil)
    {
        ...
        [_collectionView registerClass:[VideoPlayCollectionViewCell class] forCellWithReuseIdentifier:LZBVideoPlayCollectionViewCellID];
    }
